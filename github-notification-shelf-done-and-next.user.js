...
(() => {
  ...
  // shift+F12 triggers the "Done & next" button. Capture phase + e.code so we
  // beat the browser's own F12 handling.
  document.addEventListener(
    'keydown',
    (e) => {
      if (!(e.shiftKey && !e.metaKey && !e.ctrlKey && !e.altKey && e.code === 'F12')) return
      e.preventDefault()
      e.stopPropagation()
